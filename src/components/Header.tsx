...
import { Menu, X } from 'lucide-react'; // Removed the duplicate Crown import
          ...
          <div className="flex justify-between items-center px-4 sm:px-8 py-3 sm:py-4">
            ...
            <div className="flex items-center justify-center">
              <Link to="/" className="flex items-center">
                <img 
                  src="/log.png" // Path to logo in the public directory
                  alt="Lumeth Logo" 
                  className="h-[60px] w-[60px] object-contain" // Control the size of the logo
                />
